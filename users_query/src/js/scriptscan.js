...
function Horloge() {
   ...
   var months = new Array("Janvier", "Fevrier", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novombre", "Decembre");

   document.getElementById("horloge").innerHTML=weekday[dt.getDay()]+" "+dt.getDate()+" "+months[dt.getMonth()]+" "+dt.getFullYear()+" "+dt.getHours()+":"+dt.getMinutes()+":"+dt.getSeconds();
 }
...
//___________________________________________________________________//
 ...
 //
  ...
  function(){
    ...
    //___________________________________________________________________//
    // Load liste des commande page index (realtime)
    function cmd_list() {
      $.ajax({
